...
class ClimateDaily(BaseModel):
    ...
    precipitation_sum: Optional[List[Optional[float]]] = Field(None, ge=0, description="Total precipitation (mm)")
    rain_sum: Optional[List[Optional[float]]] = Field(None, ge=0, description="Rain total (mm)")
    snowfall_sum: Optional[List[Optional[float]]] = Field(None, ge=0, description="Snowfall (mm water equivalent)")
    relative_humidity_2m_max: Optional[List[Optional[float]]] = Field(None, ge=0, le=100, description="Max humidity (%)")
    relative_humidity_2m_min: Optional[List[Optional[float]]] = Field(None, ge=0, le=100, description="Min humidity (%)")
    relative_humidity_2m_mean: Optional[List[Optional[float]]] = Field(None, ge=0, le=100, description="Mean humidity (%)")
    wind_speed_10m_mean: Optional[List[Optional[float]]] = Field(None, ge=0, description="Mean wind speed (km/h)")
    wind_speed_10m_max: Optional[List[Optional[float]]] = Field(None, ge=0, description="Max wind speed (km/h)")
    pressure_msl_mean: Optional[List[Optional[float]]] = Field(None, description="Mean pressure (hPa)")
    cloud_cover_mean: Optional[List[Optional[float]]] = Field(None, ge=0, le=100, description="Mean cloud cover (%)")
    shortwave_radiation_sum: Optional[List[Optional[float]]] = Field(None, ge=0, description="Total solar radiation (MJ/m²)")
    soil_moisture_0_to_10cm_mean: Optional[List[Optional[float]]] = Field(None, ge=0, le=1, description="Soil moisture (0-1 m³/m³)")
