 ...
 */
function createWeatherTempChart(data) {
    ...
    const maxTemps = [22, 24, 23, 25, 26, 24, 23];
    const minTemps = [15, 16, 15, 17, 18, 16, 15];
    ...
    console.log('✅ Weather temperature chart created');
}
 ...
 */
function createWeatherWindChart(data) {
...
function createAirQualityChart(data) {
    ...
    // Sample data (24 hours)
    const labels = ['00:00', '03:00', '06:00', '09:00', '12:00', '15:00', 
                    '18:00', '21:00', '24:00'];
...
function createSatelliteChart(data) {
    ...
    const labels = ['06:00', '07:00', '08:00', '09:00', '10:00', '11:00', 
                    '12:00', '13:00', '14:00', '15:00', '16:00', '17:00', '18:00'];
    
    // Radiation values in W/m² (Watts per square meter)
    const shortwaveRadiation = [50, 150, 300, 450, 600, 750, 850, 800, 700, 550, 400, 250, 100];
    const directRadiation = [30, 100, 200, 350, 480, 600, 680, 640, 560, 440, 320, 200, 80];
    const diffuseRadiation = [20, 50, 100, 100, 120, 150, 170, 160, 140, 110, 80, 50, 20];
